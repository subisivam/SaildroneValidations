...
df.to_csv('/Users/subhatrasivam/Documents/Internships/NOAA/Code/Saildrone/SD2017M2avghr.csv')
print('...end 2017.')
###################################################################################################
### 2018 ###
print('start 2018...')
...
df = pd.DataFrame(for_df.T, columns=['id','hours','lat','lon','eflux','hflux','qair','qskn','airtemp','skntemp','wind','sp'])
df.to_csv('/Users/subhatrasivam/Documents/Internships/NOAA/Code/Saildrone/SD2018M2avghr.csv')
print('...end 2018.')
###################################################################################################
### 2019 ###
print('start 2019...')
...
df = pd.DataFrame(for_df.T, columns=['id','hours','lat','lon','eflux','hflux','qair','qskn','airtemp','skntemp','wind','sp'])
df.to_csv('/Users/subhatrasivam/Documents/Internships/NOAA/Code/Saildrone/SD2019M2avghr.csv')
print('...end 2019.')

print('end SAILDRONE DATA EXTRACTION for MERRA2.')