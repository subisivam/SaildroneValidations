...
# paths
sd = '/Users/subhatrasivam/Documents/Internships/NOAA/Code/Saildrone/SD2017avghr.csv'

merra2prod = '/Users/subhatrasivam/Documents/Internships/NOAA/Code/MERRA2/2017MERRA2interp.csv'

filepath = '/Users/subhatrasivam/Documents/Internships/NOAA/Code/MERRA2/plots/2017/'
...
for num in monthnum[0]:
    ...
    for days in datestuff[0]:
        ...
        k = k + 1
labeldates = ['7/14','7/24','8/3','8/13','8/23','9/2','9/12','9/22','10/2']
splitdate = []
monthlabel = []
for d in labeldates:
    sepdate = d.split('/')
...
plt.title('Saildrone Latent Heat Flux in 2017')
plt.rc('font', **font)
...
plt.plot(xfit,yfit,':',c='k',lw = 1)
plt.title('Saildrone Sensible Heat Flux in 2017')
plt.rc('font', **font)
plt.xlim(np.min(months_sd)-0.3,np.max(months_sd)+0.3)
plt.xticks(monthlabel,labeldates)
plt.xlabel('Dates in 2017')
...
plt.plot(xfit,yfit,':',c='k',lw = 1)
plt.title('MERRA2 Latent Heat Flux in 2017')
plt.rc('font', **font)
plt.xlim(np.min(months_sd)-0.3,np.max(months_sd)+0.3)
plt.xticks(monthlabel,labeldates)
plt.xlabel('Dates in 2017')
...
plt.plot(xfit,yfit,':',c='k',lw = 1)
plt.title('MERRA2 Sensible Heat Flux in 2017')
plt.rc('font', **font)
plt.xlim(np.min(months_sd)-0.3,np.max(months_sd)+0.3)
plt.xticks(monthlabel,labeldates)
plt.xlabel('Dates in 2017')
...
plt.title('MERRA2-Saildrone Latent Heat Flux Difference in 2017')
plt.rc('font', **font)
plt.xlim(np.min(months_sd)-0.3,np.max(months_sd)+0.3)
plt.xticks(monthlabel,labeldates)
plt.xlabel('Dates in 2017')
...
for stdi in stdint:
    ...
    plt.axhline(y = stdval,xmin = -1000,xmax = 1000,color = stdcolor,label = stdlabel,linestyle='dotted',lw = 3)
plt.title('MERRA2-Saildrone Sensible Heat Flux Difference in 2017')
plt.rc('font', **font)
plt.xlim(np.min(months_sd)-0.3,np.max(months_sd)+0.3)
plt.xticks(monthlabel,labeldates)
plt.xlabel('Dates in 2017')
...
plt.plot(xfit,yfit,':',c='k',lw = 1)
plt.title('Saildrone Latent Heat Flux Sorted by MERRA2-Saildrone $\sigma$ in 2017')
plt.rc('font', **font)
plt.xlim(np.min(months_sd)-0.3,np.max(months_sd)+0.3)
plt.xticks(monthlabel,labeldates)
plt.xlabel('Dates in 2017')
...
plt.plot(xfit,yfit,':',c='k',lw = 1)
plt.title('Saildrone Sensible Heat Flux Sorted by MERRA2-Saildrone $\sigma$ in 2017')
plt.rc('font', **font)
plt.xlim(np.min(months_sd)-0.3,np.max(months_sd)+0.3)
plt.xticks(monthlabel,labeldates)
plt.xlabel('Dates in 2017')
...
plt.plot(monthmore,efluxmore,'.',c=col_ls_range[3],markersize=8,label='>3$\sigma$')
plt.plot(xfit,yfit,':',c='k',lw = 1)
plt.title('MERRA2 Latent Heat Flux Sorted by MERRA2-Saildrone $\sigma$ in 2017')
plt.rc('font', **font)
plt.xlim(np.min(months_sd)-0.3,np.max(months_sd)+0.3)
plt.xticks(monthlabel,labeldates)
plt.xlabel('Dates in 2017')
...
plt.plot(monthmore,hfluxmore,'.',c=col_ss_range[3],markersize=8,label='>3$\sigma$')
plt.plot(xfit,yfit,':',c='k',lw = 1)
plt.title('MERRA2 Sensible Heat Flux Sorted by MERRA2-Saildrone $\sigma$ in 2017')
plt.rc('font', **font)
plt.xlim(np.min(months_sd)-0.3,np.max(months_sd)+0.3)
plt.xticks(monthlabel,labeldates)
plt.xlabel('Dates in 2017')
